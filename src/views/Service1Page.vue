...
export default {
  ...
  methods: {
    saveEdit() {
      ...
      localStorage.setItem('hasDeliveryPartner1', this.editedHasDeliveryPartner.toString());
  ...
  created() {
    ...
    const storedHasDeliveryPartner = localStorage.getItem('hasDeliveryPartner1');
