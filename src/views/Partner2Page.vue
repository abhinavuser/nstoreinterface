...
export default {
  ...
  data() {
    return {
      ...
      amount: 'Amount 2',
      editMode: false,
      editedPartnerName: 'Partner 2',
      editedLocation: 'Location 2',
      editedAmount: 'Amount 2'
    };
  },
  methods: {
    saveEdit() {
      // Save edited data to localStorage or backend
      localStorage.setItem('partnerName2', this.editedPartnerName);
      localStorage.setItem('location2', this.editedLocation);
      localStorage.setItem('amount2', this.editedAmount);
  ...
  created() {
    ...
    const storedPartnerName = localStorage.getItem('partnerName2');
    const storedLocation = localStorage.getItem('location2');
    const storedAmount = localStorage.getItem('amount2');
