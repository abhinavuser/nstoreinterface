...
export default {
  ...
  data() {
    return {
      partnerName: 'Service Partner 2',
      hasDeliveryPartner: false,
      editMode: false,
      editedPartnerName: 'Service Partner 2',
  ...
  methods: {
    saveEdit() {
      ...
      localStorage.setItem('hasDeliveryPartner2', this.editedHasDeliveryPartner.toString());
  ...
  created() {
    ...
    const storedHasDeliveryPartner = localStorage.getItem('hasDeliveryPartner2');
